...
class field_controller extends \core_customfield\field_controller {
    ...
    public function config_form_definition(\MoodleQuickForm $mform) {
        // Add elements.
        $mform->addElement('header', 'header_specificsettings', get_string('specificsettings', 'customfield_cost'));
        ...
        $mform->addElement(
            ...
            get_string('currencies', 'customfield_cost'),
            $stringmanager->get_list_of_currencies(),
            ['multiple' => 'multiple']
        );
    }
